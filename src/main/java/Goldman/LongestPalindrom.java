...
//        String str = "forgeeksskeegfor";
    ...
    public static void print2D(boolean mat[][]) {
        ...
        for (boolean[] row : mat) {
            ...
            System.out.print(str0.toCharArray()[c] + " ");
            c++;
            for (boolean x : row) {

                System.out.print(translate(x) + " ");
            }
            System.out.println();
        }
    }

    private static String translate(boolean x) {
        return x ? "1" : "0";
    }
}
